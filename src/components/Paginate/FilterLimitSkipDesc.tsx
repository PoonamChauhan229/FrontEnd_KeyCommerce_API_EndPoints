...
const FilterLimitSkipDesc: React.FC = () => {
  ...
  const getProductEndpoint = productSection.endpoints.find(
    (endpoint) => endpoint.title === "Filter Products by Limit, Skip, and Sort by Price Descending"
  );
...
export default FilterLimitSkipDesc;
