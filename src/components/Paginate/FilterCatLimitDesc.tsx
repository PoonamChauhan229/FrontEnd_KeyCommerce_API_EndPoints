...
const FilterCatLimitDesc: React.FC = () => {
  ...
  const getProductEndpoint = productSection.endpoints.find(
    (endpoint) => endpoint.title === "Filter Products by Category, Limit, and Sort by Price Descending"
  );
...
export default FilterCatLimitDesc;
