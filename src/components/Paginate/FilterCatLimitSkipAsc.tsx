...
const FilterCatLimitSkipAsc: React.FC = () => {
  ...
  const getProductEndpoint = productSection.endpoints.find(
    (endpoint) => endpoint.title === "Filter Products by Category, Limit, Skip, and Sort by Price Ascending"
  );
...
export default FilterCatLimitSkipAsc;
